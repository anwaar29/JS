// let arr=[1,2,3,4,5,6];
// include () // it give true or false
// console.log(arr.includes(2));
// lastIndexOf(0)
// console.log(arr.lastIndexOf(6))
// findindex = return the index of the first element in the array that datisfied the provoided testing function


// whenebver you give a function as an argument to a functiom that is known as callback function
 // function cb(x){ // call back gives boolean value
  // return x>4;
 // }
// let res=arr.findIndex(cb) // when it will true it will return index value nd stored in res
 // due to findindex() the call back function will execute for each eleemnt in array
 // concat()= it will add two array to in one array 
//  let arr=["a","b","c"]
//  let arr1=["e","f"]
//  let arr3=arr.concat(arr1);
//  console.log(arr3);
//  console.log(arr3.join("-")); // element ke beech me add krega hr me 
